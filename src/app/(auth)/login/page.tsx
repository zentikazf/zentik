  ...
  return (
    <div className="rounded-[25px] bg-white p-8 shadow-sm dark:bg-gray-900">
      <div className="text-center">
        <h1 className="text-[22px] font-semibold text-gray-800 dark:text-white">Iniciar sesión</h1>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-white px-3 text-gray-400 dark:bg-gray-900">O continúa con email</span>
        </div>
      </div>
