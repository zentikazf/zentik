  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-end">
        <div className="rounded-full bg-blue-50 px-4 py-2 dark:bg-blue-950">
      ...
      {/* Budget Table */}
      <div className="overflow-x-auto rounded-[25px] bg-white dark:bg-gray-900">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
            {items.map((item) => (
              <tr key={item.id} className="group transition-colors hover:bg-gray-50 dark:hover:bg-white/5">
                ...
                <td className="px-5 py-2 font-medium text-gray-800 dark:text-white">
                ...
                <td className="px-5 py-2">
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-all">
                    <button
                      ...
                      className="flex h-7 w-7 items-center justify-center rounded-full text-gray-300 hover:bg-blue-50 hover:text-blue-500 dark:hover:bg-blue-950"
                    >
                      <ListTodo className="h-3.5 w-3.5" />
                    </button>
                    <button
                      onClick={() => deleteItem(item.id)}
                      className="flex h-7 w-7 items-center justify-center rounded-full text-gray-300 hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-950"
                    >
          ...
          <tfoot>
            <tr className="border-t-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800/50">
              <td className="px-5 py-4 font-semibold text-gray-500">TOTAL</td>
        ...
        {items.length === 0 && (
          <div className="flex flex-col items-center py-12 text-center">
            <Calculator className="mb-3 h-10 w-10 text-gray-300 dark:text-gray-600" />
            <p className="text-gray-400">No hay items en el presupuesto</p>
            <p className="mt-1 text-xs text-gray-300">Agrega líneas para comenzar</p>
          </div>
        )}
      </div>
