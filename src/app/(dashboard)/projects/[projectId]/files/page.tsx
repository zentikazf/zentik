...
export default function FilesPage() {
 ...
 <div>
 <h1 className="text-[22px] font-semibold text-foreground">Archivos</h1>
 <p className="mt-1 text-sm text-muted-foreground">Gestiona los archivos del proyecto</p>
 </div>
 <div>
 ...
 return (
 <div key={file.id} className="flex items-center gap-4 rounded-xl border border-border bg-card p-5">
