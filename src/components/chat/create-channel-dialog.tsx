          ...
          {tab === 'DM' && (
            <div className="space-y-2">
              ...
              <div className="max-h-48 space-y-1 overflow-y-auto">
                ...
                {orgMembers.length === 0 && (
                  <p className="py-4 text-center text-sm text-gray-400">No hay miembros disponibles</p>
                )}
              </div>
            </div>
          )}
            ...
            <>
              <div className="space-y-2">
                ...
                <div className="max-h-48 space-y-1 overflow-y-auto">
                  ...
                  {projects.length === 0 && (
                    <p className="py-4 text-center text-sm text-gray-400">No hay proyectos disponibles</p>
                  )}
                </div>
              </div>
              <div className="space-y-2">
