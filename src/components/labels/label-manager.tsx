  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-800 dark:text-white">Etiquetas</h3>
        {!creating && (
      ...
      {loading ? (
        ...
        <p className="text-sm text-gray-400">No hay etiquetas creadas</p>
      ) : (
          ...
          {labels.map((label) => (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-gray-800 dark:text-white">{label.name}</span>
              </div>
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className="rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-950"
                >
