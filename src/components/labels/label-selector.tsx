    ...
    <div className="space-y-2">
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className="w-56 p-2" align="start">
          {loading ? (
            <p className="p-2 text-center text-xs text-gray-400">Cargando...</p>
          ) : allLabels.length === 0 ? (
            <p className="p-2 text-center text-xs text-gray-400">No hay etiquetas. Crea una desde Configuración.</p>
          ) : (
